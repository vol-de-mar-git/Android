package ru.mirea.medvedevvladislav.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickSendNtfn(View view)
    {
        ...
        notificationChannel.setLightColor(Color.RED);notificationChannel.setVibrationPattern(new long[]{0, 1000, 500, 1000});
